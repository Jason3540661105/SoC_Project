...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/hw2/hw2/hw2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw2_wrapper.tcl -notrace
