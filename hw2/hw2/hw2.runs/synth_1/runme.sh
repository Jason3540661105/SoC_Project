...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/hw2/hw2/hw2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw2_wrapper.tcl
