...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/final_project/Code/Sokoban_Game_sdk/Sokoban_Game/Sokoban_Game.runs/sokoban_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sokoban_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sokoban_axi_gpio_0_0.tcl
