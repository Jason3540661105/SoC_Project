...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/final_project/Code/Sokoban_Game_sdk/Sokoban_Game/Sokoban_Game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sokoban_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sokoban_wrapper.tcl -notrace
