...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/final_project/Code/test/sdk/uart_test1/uart_test1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_test1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_test1_wrapper.tcl
