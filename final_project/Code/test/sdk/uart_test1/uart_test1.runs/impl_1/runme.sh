...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/final_project/Code/test/sdk/uart_test1/uart_test1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_test1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_test1_wrapper.tcl -notrace
