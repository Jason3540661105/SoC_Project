...
#
# Generated by export_simulation on Thu Dec 07 16:16:41 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './uart_test1.sh' script.

./uart_test1.sh -reset_run
...
./uart_test1.sh -noclean_files

For more information on the script, please type './uart_test1.sh -help'.
