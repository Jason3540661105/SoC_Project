...
#
# Generated by export_simulation on Thu Oct 12 16:11:42 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './interrupt.sh' script.

./interrupt.sh -reset_run
...
./interrupt.sh -noclean_files

For more information on the script, please type './interrupt.sh -help'.
