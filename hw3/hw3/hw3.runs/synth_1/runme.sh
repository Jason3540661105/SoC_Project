...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/hw3/hw3/hw3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interrupt_wrapper.tcl
