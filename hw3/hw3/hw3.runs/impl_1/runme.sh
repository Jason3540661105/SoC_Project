...
HD_PWD='C:/Users/jason/Desktop/verilog_lab/soc_work/hw3/hw3/hw3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interrupt_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interrupt_wrapper.tcl -notrace
